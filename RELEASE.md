...
dist plan --tag v0.1.3 --allow-dirty
```
...
For v0.1.3, cargo-dist is configured to create GitHub Release assets for:
...
curl --proto '=https' --tlsv1.2 -LsSf \
  https://github.com/Cause-of-a-Kind/skilldeck/releases/download/v0.1.3/skilldeck-installer.sh \
...
Invoke-RestMethod https://github.com/Cause-of-a-Kind/skilldeck/releases/download/v0.1.3/skilldeck-installer.ps1 -OutFile $installer
& $installer
